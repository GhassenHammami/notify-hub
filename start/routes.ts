...
router
  .group(() => {
    router
      .post('/notifications', '#controllers/api_controller.sendNotification')
      .as('api.sendNotification')
    router
      .get('/notifications/:id', '#controllers/api_controller.getNotificationStatus')
      .as('api.getNotificationStatus')
  })
  .prefix('/api/v1')
  .as('api')
